...
import yellow_zag_alt from '../assets/confetti/yellow_zag_alt.svg'
...
const shapeData = [
  ...
  { name: "blue donut",       src: blue_donut,        x: 1360,  y: 830 },
...
const confettiData = [
  ...
  { name: "yellow x alt confetti", src: yellow_x_alt, x: 1330, y: 720 },
  { name: "pink circle alt confetti", src: pink_circle_alt, x: 1330, y: 910 },
  { name: "navy zag confetti", src: navy_zag, x: 1060, y: 868 },
  { name: "yellow zag alt confetti", src: yellow_zag_alt, x: 606, y: 840 },
  { name: "plum circle confetti", src: plum_circle, x: 304, y: 834 },
